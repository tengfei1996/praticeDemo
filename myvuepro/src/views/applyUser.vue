  ...
  <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
    ...
    <Form-item label="爱好" prop="interest">
      <Checkbox-group v-model="formValidate.interest">
        ...
        <Checkbox label="玩蛇"></Checkbox>
        <Checkbox label="打桩"></Checkbox>
      </Checkbox-group>
    </Form-item>
      ...
      return {
        ...
        ruleValidate: {
          ...
          phoneNumber: [
            ...
            { pattern: '^1(3|4|5|6|7|8|9)\\d{9}$', message: '错误的手机格式', trigger: 'blur' }
          ],
          idCard: [
            { required: true, message: '身份证不能为空', trigger: 'blur' },
            { pattern: '^[1-9]\\d{5}(18|19|20|(3\\d))\\d{2}((0[1-9])|(1[0-2]))(([0-2][1-9])|10|20|30|31)\\d{3}[0-9Xx]$', message: '错误的身份证格式', trigger: 'blur' }
          ],
          mail: [
